// Auto-generated enhanced bundle for pricing module
...
(function() {
    ...
    // Override the existing pricing module with enhanced version
    window.ModuleContent.pricing = {
        html: `<!-- Enhanced Pricing Module Dashboard -->
<div class="pricing-container">
    ...
    <div class="module-header">
        ...
        <div class="tabs">
            <button class="tab" onclick="ChApp.loadView('planning')">Planning</button>
        ...
        <table class="products-table">
            <thead>
                <tr>
                    ...
                    <th class="col-dual-chart">Cost Analysis & Price Coverage</th>
...
<div id="product-modal" class="modal" style="display: none;">
    ...
    <div class="modal-content">
        ...
        <form id="product-form" onsubmit="return Pricing.saveProduct(event)">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="unit_type" value="pcs" placeholder="e.g., pcs, kg">
                    </div>
                    <div class="form-group">
                        <label>Group 1</label>
            ...
            <div class="form-section">
                <h4>Cost Components (EUR) - 4 Decimal Places</h4>
                <div class="form-grid">
                    <div class="form-group">
                        <label>Production Cost</label>
                        <input type="number" name="production_cost" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                        <label>Production Overhead</label>
                        <input type="number" name="production_overhead" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                        <label>Logistics Overhead</label>
                        <input type="number" name="logistics_overhead" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                        <label>Marketing Overhead</label>
                        <input type="number" name="marketing_overhead" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                        <label>General Overhead</label>
                        <input type="number" name="general_overhead" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                        <label>Profit Overhead</label>
                        <input type="number" name="profit_overhead" step="0.0001" min="0" value="0.0000" onchange="Pricing.calculateTotal()">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="sales_price" step="0.0001" min="0" value="0.0000" required onchange="Pricing.calculateTotal()">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-preview">
                    <h5>Cost Coverage Preview</h5>
                    <div id="preview-chart" class="preview-container">
...
<div id="import-modal" class="modal" style="display: none;">
    ...
    <div class="modal-content modal-small">
        ...
        <div class="import-instructions">
            ...
            <ul>
                ...
                <li>Article Name</li>
                <li>Pack Size</li>
                <li>Cost components (Production, Overheads) - 4 decimal places</li>
                <li>Sales Price - 4 decimal places</li>
            </ul>
    ...
    console.log('Enhanced Pricing module bundle loaded');
})();